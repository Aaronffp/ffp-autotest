...
/**
 * <strong>获取字符串</strong><br>
 * 
 * @author FanFengping
 * @version V1.0.0: ffp-autotest-jmeter ffp.autotest.jmeter.functions JedisGetFunction.java Exp $
 */
public class JedisGetFunction extends AbstractFunction {
    private static final List<String> desc = new LinkedList<String>();
    private static final String       KEY  = "__REDIS_GET";
    ...
    public String execute(SampleResult arg0, Sampler arg1) throws InvalidVariableException {JMeterVariables localJMeterVariables = getVariables();
        ...
        String storeValue = redis.get(key);
