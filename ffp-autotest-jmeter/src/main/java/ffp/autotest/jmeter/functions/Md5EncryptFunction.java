...
/**
 * <strong>MD5加密函数扩展（32）</strong><br>
 * 
 * @author FanFengping
 * @version V1.0.0: ffp-autotest-jmeter ffp.autotest.jmeter.functions Md5EncryptFunction.java, 2016-04-30 20:44:12 Exp $
 */
public class Md5EncryptFunction extends AbstractFunction {
    public Md5EncryptFunction() {
        super();
    }
